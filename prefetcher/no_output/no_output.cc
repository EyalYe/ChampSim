/*
 * This Prefetcher is used to output accesses to a CSV file for training a machine learning model.
*/
...
std::string access_type_to_string_no_output(access_type type) {
  switch (type) {
...
uint32_t no_output::prefetcher_cache_operate(champsim::address addr, champsim::address ip,
                                      ...
                                      access_type type, uint32_t metadata_in)
{
  ...
  debug_file << std::hex << addr << ","
             ...
             << access_type_to_string_no_output(type) << "\n";
...
uint32_t no_output::prefetcher_cache_fill(champsim::address addr, long set, long way, uint8_t prefetch, champsim::address evicted_addr, uint32_t metadata_in)
{
  return metadata_in;
}
